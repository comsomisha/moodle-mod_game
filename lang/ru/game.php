...
$string[ 'millionaire_must_select_questioncategory'] = 'Вы должны выбрать категорию вопросов';
$string[ 'millionaire_must_select_quiz'] = 'Вы должны выбрать квиз';
...
$string[ 'millionaire_helppeople'] = 'Помощь людей';
$string[ 'millionaire_info'] = 'Один неверный ответ был забыт';
$string[ 'millionaire_info_wrong_answer'] = 'Ваш ответ неверен<br>Правильный ответ:';
$string[ 'millionaire_quit'] = 'Выход';
$string[ 'millionaire_sourcemodule_must_quiz_question'] = 'Источник должен состоять из {$a} или вопросов';
$string[ 'millionaire_telephone'] = 'Звонок другу';
$string[ 'must_select_questioncategory'] = 'Выберите категорию вопросов';
$string[ 'must_select_quiz'] = 'Выберите квиз';
...
$string[ 'game_millionaire'] = 'Вершина';
